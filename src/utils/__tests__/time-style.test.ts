...
describe('relativeTimeStyle', () => {
  ...
  it('returns green for 4-5 minutes (181-300s)', () => {
    expect(relativeTimeStyle(181).color).toBe('#43a047');
    expect(relativeTimeStyle(300).color).toBe('#43a047');
  });

  it('returns blue for 6-10 minutes (301-600s)', () => {
    expect(relativeTimeStyle(301).color).toBe('#1e88e5');
    expect(relativeTimeStyle(600).color).toBe('#1e88e5');
  });

  it('returns gray 0.8 for 11-15 minutes (601-900s)', () => {
    const style = relativeTimeStyle(601);
    expect(style.color).toBe('#757575');
    expect(style.opacity).toBe(0.8);
    expect(relativeTimeStyle(900).color).toBe('#757575');
  });

  it('returns gray 0.6 for 16-30 minutes (901-1800s)', () => {
    const style = relativeTimeStyle(901);
    expect(style.color).toBe('#757575');
    expect(style.opacity).toBe(0.6);
  });

  it('returns gray 0.4 for 31-60 minutes (1801-3600s)', () => {
  ...
  it('returns textColor for each band', () => {
    ...
    expect(relativeTimeStyle(300).textColor).toBe('#ffffff');
    expect(relativeTimeStyle(600).textColor).toBe('#ffffff');
  });
});
...
describe('relativeTimeColor', () => {
  it('returns color string for each band', () => {
    ...
    expect(relativeTimeColor(400)).toBe('#1e88e5');
    expect(relativeTimeColor(700)).toBe('#757575');
