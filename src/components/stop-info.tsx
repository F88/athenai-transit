  ...
  return (
    <div className="min-w-0 flex-1">
      ...
      <div className="m-0 flex flex-wrap items-center gap-1">
        <p className="m-0 inline-flex flex-wrap items-center text-base font-semibold text-[#1565c0] dark:text-blue-400">
          <span className="mr-1 text-[22px]">{routeTypesEmoji(routeTypes)}</span>
          <span className="align-middle">{stopNames.name}</span>
