  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="border-info flex max-h-[80dvh] w-[90dvw] max-w-5xl flex-col gap-0 overflow-hidden border-4 p-4 sm:max-w-3xl"
      >
        <DialogHeader className="border-border relative shrink-0 border-b pb-3 sm:text-center">
          ...
          <DialogTitle className="text-base">{t('info.title')}</DialogTitle>
