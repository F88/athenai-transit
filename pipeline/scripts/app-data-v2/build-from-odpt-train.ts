 ...
 *   npx tsx pipeline/scripts/app-data-v2/build-from-odpt-train.ts --targets <file>
 *   npx tsx pipeline/scripts/app-data-v2/build-from-odpt-train.ts --list
 */
...
function printUsage(): void {
  console.log('Usage: npx tsx pipeline/scripts/app-data-v2/build-from-odpt-train.ts <source-name>');
  console.log(
    '       npx tsx pipeline/scripts/app-data-v2/build-from-odpt-train.ts --targets <file>',
  );
  console.log('       npx tsx pipeline/scripts/app-data-v2/build-from-odpt-train.ts --list\n');
  console.log('Options:');
