 ...
 *   npx tsx pipeline/scripts/app-data-v2/build-from-gtfs.ts --targets <file>
 *   npx tsx pipeline/scripts/app-data-v2/build-from-gtfs.ts --list
 */
...
function printUsage(): void {
  console.log('Usage: npx tsx pipeline/scripts/app-data-v2/build-from-gtfs.ts <source-name>');
  console.log('       npx tsx pipeline/scripts/app-data-v2/build-from-gtfs.ts --targets <file>');
  console.log('       npx tsx pipeline/scripts/app-data-v2/build-from-gtfs.ts --list\n');
  console.log('Options:');
