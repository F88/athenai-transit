 ...
 *   npx tsx pipeline/scripts/pipeline/download-gtfs.ts toei-train
 *
 * Features:
...
function printUsage(): void {
  console.log('Usage: npx tsx pipeline/scripts/pipeline/download-gtfs.ts <source-name>');
  console.log('       npx tsx pipeline/scripts/pipeline/download-gtfs.ts --targets <file>');
  console.log('       npx tsx pipeline/scripts/pipeline/download-gtfs.ts --list\n');
  console.log('Options:');
