 ...
 *
 * Usage:
 *   npx tsx pipeline/scripts/pipeline/check-odpt-resources.ts              # all tracked sources
 *   npx tsx pipeline/scripts/pipeline/check-odpt-resources.ts kanto-bus     # single source
 *   npx tsx pipeline/scripts/pipeline/check-odpt-resources.ts --all         # all ODPT sources (including not tracked)
 *   npx tsx pipeline/scripts/pipeline/check-odpt-resources.ts --list        # list tracked ODPT sources
 *   npx tsx pipeline/scripts/pipeline/check-odpt-resources.ts --format tsv  # TSV output
 *
...
function printUsage(): void {
  console.log(
    'Usage: npx tsx pipeline/scripts/pipeline/check-odpt-resources.ts [options] [source-name]',
  );
  console.log('');
  console.log('Options:');
