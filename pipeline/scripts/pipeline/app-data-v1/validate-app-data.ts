 ...
 *
 * Target: pipeline/workspace/_build/data/{prefix}/ — the JSON files generated by
 * the pipeline build scripts for the web app.
 *
 * Validation steps:
 *   --targets mode (batch): 3 steps
 *     1. Unvalidated directory check — detects dirs not in targets list
 *     2. File existence check — verifies required JSON files exist
 *     3. Calendar freshness check — inspects service end_date
 *   Single prefix mode: steps 2 and 3 only
 *
...
function printUsage(): void {
  ...
  console.log('  --targets <file> Validate prefixes listed in a targets file');
