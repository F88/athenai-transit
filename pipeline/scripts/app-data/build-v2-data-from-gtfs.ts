 ...
 *
 * Usage:
 *   npx tsx pipeline/scripts/app-data/build-v2-data-from-gtfs.ts <source-name>
 *   npx tsx pipeline/scripts/app-data/build-v2-data-from-gtfs.ts --targets <file>
 *   npx tsx pipeline/scripts/app-data/build-v2-data-from-gtfs.ts --list
 */
...
import { extractAgenciesV2 } from './lib/v2-extract-agencies';
import { writeDataBundle } from './lib/v2-bundle-writer';
import { extractCalendarV2 } from './lib/v2-extract-calendar';
import { extractFeedInfoV2 } from './lib/v2-extract-feed-info';
...
import { extractTripPatternsAndTimetable } from './lib/v2-extract-timetable';
import { extractTranslationsV2 } from './lib/v2-extract-translations';
...
function printUsage(): void {
  console.log('Usage: npx tsx pipeline/scripts/app-data/build-v2-data-from-gtfs.ts <source-name>');
  console.log(
    '       npx tsx pipeline/scripts/app-data/build-v2-data-from-gtfs.ts --targets <file>',
  );
  console.log('       npx tsx pipeline/scripts/app-data/build-v2-data-from-gtfs.ts --list\n');
  console.log('Options:');
...
async function main(): Promise<void> {
  ...
  if (arg.kind === 'targets') {
    ...
    const scriptPath = resolve(import.meta.dirname, 'build-v2-data-from-gtfs.ts');
