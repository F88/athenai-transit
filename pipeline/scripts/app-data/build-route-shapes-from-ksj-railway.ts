 ...
 *   npx tsx pipeline/scripts/app-data/build-route-shapes-from-ksj-railway.ts --targets <file>
...
function printUsage(): void {
  console.log(
    'Usage: npx tsx pipeline/scripts/app-data/build-route-shapes-from-ksj-railway.ts <source-name>',
  );
  console.log(
    '       npx tsx pipeline/scripts/app-data/build-route-shapes-from-ksj-railway.ts --targets <file>',
  );
