 ...
 *
 * Usage:
 *   npx tsx pipeline/scripts/app-data/analyze-gtfs-stop-times.ts              # all sources
 *   npx tsx pipeline/scripts/app-data/analyze-gtfs-stop-times.ts <source>     # single source
 *   npx tsx pipeline/scripts/app-data/analyze-gtfs-stop-times.ts --list       # list sources
 */
