...
| 3     | v2 ShapesBundle の検証                | `scripts/pipeline/app-data-v2/validate-shapes-bundle.ts`              | `npm run pipeline:validate:v2-shapes`   |
...
npm run pipeline:validate:v2-shapes      # v2 shapes ビルドの後
