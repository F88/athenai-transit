 ...
 *
 * Usage:
 *   npx tsx pipeline/scripts-for-dev/dev-tools.ts              # interactive selection
 *   npx tsx pipeline/scripts-for-dev/dev-tools.ts <script-name> # direct execution
 *   npx tsx pipeline/scripts-for-dev/dev-tools.ts --list        # list available scripts
 */
