...
| スクリプト              | 対象      | 入力                                | 出力                       |
| ----------------------- | --------- | ----------------------------------- | -------------------------- |
| `download-gtfs.ts`      | GTFS ZIP  | `pipeline/resources/gtfs/*.ts`      | `pipeline/workspace/data/gtfs/`      |
| `download-odpt-json.ts` | ODPT JSON | `pipeline/resources/odpt-json/*.ts` | `pipeline/workspace/data/odpt-json/` |
