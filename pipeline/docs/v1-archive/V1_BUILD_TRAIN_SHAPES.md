...
```text
Usage: npx tsx pipeline/scripts/pipeline/app-data-v1/build-route-shapes-from-ksj-railway.ts
       npx tsx pipeline/scripts/pipeline/app-data-v1/build-route-shapes-from-ksj-railway.ts --help
