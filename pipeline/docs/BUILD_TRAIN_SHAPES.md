...
```
Usage: npx tsx pipeline/scripts/app-data/build-route-shapes-from-ksj-railway.ts
       npx tsx pipeline/scripts/app-data/build-route-shapes-from-ksj-railway.ts --help
